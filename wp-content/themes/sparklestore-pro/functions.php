...
/**
CUSTOM TEXT IN PRODUCT DETAIL PAGE
 */
add_action( 'woocommerce_after_add_to_cart_quantity', 'misha_after_add_to_cart_btn' );
 
function misha_after_add_to_cart_btn(){
	echo '<p style="color: red; font-size:12px; padding-top: 10px;">Minimum purchase limit is 10 pieces</p>';
}