...
Tags: Quantity, Minimum Quantity, Maximum quantity, Products quantity, Category quantity, Order quantity, Order item
...
== Screenshots ==
1. How to do global checkout settings.
2. Global Manage Messages
3. Add new Min max Rules.
4. Edit the Min Max rules.
