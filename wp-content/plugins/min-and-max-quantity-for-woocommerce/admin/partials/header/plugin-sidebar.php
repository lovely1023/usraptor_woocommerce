        ...
        <div class="video-detail important-link">
            <ul>
                <li>
                    ...
                    <a target="_blank" href="<?php echo esc_url('#'); ?>"><?php esc_html_e('Plugin documentation', 'min-and-max-quantity-for-woocommerce'); ?></a>
                </li>
                <li>
                    <img src="<?php echo esc_url( $image_url ); ?>">
                ...
                <li>
                    <img src="<?php echo esc_url( $image_url ); ?>">
                    <a target="_blank" href="<?php echo esc_url('www.thedotstore.com/suggest-a-feature'); ?>"><?php esc_html_e('Suggest A Feature', 'min-and-max-quantity-for-woocommerce'); ?></a>
                </li>
                <li>
                    <img src="<?php echo esc_url( $image_url ); ?>">
